...
/**	    \file       htdocs/etransactions/tpl/admin.config.tpl.php
 *		\ingroup    ndfp
 *		\brief      Admin setup view
 */
 
llxHeader('', $langs->trans('SherlocksAdmin'));

echo ($message ? dol_htmloutput_mesg($message, '', ($error ? 'error' : 'ok'), 0) : '');

print_fiche_titre($langs->trans('SherlocksAdmin'), $linkback, 'setup');
...
<br />
<?php echo $langs->trans("SherlocksDesc"); ?>
<br />
...
<tr class="pair">
    <td class="fieldrequired"><?php echo $langs->trans("ApiId"); ?></td>
    <td><input size="32" type="text" name="api_id" value="<?php echo $api_id; ?>" /></td>
    <td><?php echo $form->textwithpicto('', $htmltooltips['ApiId'], 1, 0); ?></td>    
</tr>
...
<tr class="pair">
    <td class="fieldrequired"><?php echo $langs->trans("ApiRank"); ?></td>
    <td><input size="32" type="text" name="api_rank" value="<?php echo $api_rank; ?>" /></td>
    <td><?php echo $form->textwithpicto('', $htmltooltips['ApiRank'], 1, 0); ?></td>    
</tr>
-->
<tr class="impair">
    <td class="fieldrequired"><?php echo $langs->trans("ApiKey"); ?></td>
    <td><textarea rows="10" cols="35" name="api_key" id="api_key"><?php echo $api_key; ?></textarea></td>
    <td><?php echo $form->textwithpicto('', $htmltooltips['ApiKey'], 1, 0); ?></td>    
</tr>

<tr class="pair">
    <td class="fieldrequired"><?php echo $langs->trans("ApiCgi"); ?></td>
    <td><input size="32" type="text" name="api_cgi" value="<?php echo $api_cgi; ?>"/></td>
    <td><?php echo $form->textwithpicto('', $htmltooltips['ApiCgi'], 1, 0); ?></td>    
</tr>
